...
add_music(dance_1, Dance2_NEW, mu_dancesecret, 0);
add_music(dance_8, Dance2_NEW, mu_dancesecret, 1);
add_music(dance_9, Dance_NEW, mu_dancesecret, 1);
...
add_music(bee_1, mu_bee, mu_what, 0);
add_music(bee_7, BuzzyNEW, mu_what, 1);
