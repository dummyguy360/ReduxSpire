    ...
    with (b)
    {
        ...
        if (instance_exists(identity) && identity.object_index == obj_player && !global.freezeframe)
        {
            switch (identity.state)
            {
                ...
                default:
                    if (identity.state == states.mach2 || identity.state == states.mach3)
