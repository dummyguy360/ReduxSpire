function state_player_minecart()
{
    ...
    else if (inputBufferJump > 0 && grounded)
    {
        inputBufferJump = 0;
        vsp = -10;
        image_index = 0;
    ...
    if (!grounded)
    {
        if (sprite_index == spr_player_PZ_minecart || sprite_index == groundedlandsprite)
    ...
    if (grounded)
    {
        if ((sprite_index == spr_player_PZ_minecart_fall || sprite_index == spr_player_PZ_minecart_jump) && vsp > 0)
        {
        ...
        if (sprite_index == spr_player_PZ_minecart_land && animation_end())
            sprite_index = groundedsprite;
        
        if (sprite_index != groundedsprite && (sprite_index == spr_player_minecartfast || sprite_index == spr_player_PZ_minecart))
            sprite_index = groundedsprite;
    }
    
    if (sprite_index == spr_player_minecartfast || sprite_index == spr_player_PZ_minecart)
