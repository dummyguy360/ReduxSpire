function scr_setgmliverooms(arg0)
{
    var _bool = false;
    
    switch (room_get_name(arg0))
    {
        case "exitway_1":
        case "exitway_2":
        case "exitway_3":
...
global.smallfont_new = font_add_sprite_ext(spr_smallfont_new, "ABCDEFGHIJKLMNOPQRSTUVWXYZ.\"-1234567890:", 1, 0);
global.candlefont = font_add_sprite_ext(spr_fontcandle, "0123456789", 1, 0);
global.combofont_new = font_add_sprite_ext(spr_tvHUD_comboFont, "0123456789", 1, 0);
...
global.panicbg = ini_read_real("Settings", "bgmelt", 0);
