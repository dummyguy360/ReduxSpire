function scr_confecti_normal()
{
    ...
    if (obj_player.state == states.backbreaker && obj_player.sprite_index == obj_player.spr_taunt && state != confectistate.taunt)
    {
    ...
    if (obj_player.state == states.backbreaker && (obj_player.sprite_index == spr_player_PZ_superTaunt_1 || obj_player.sprite_index == spr_player_PZ_superTaunt_2 || obj_player.sprite_index == spr_player_PZ_superTaunt_3 || obj_player.sprite_index == spr_player_PZ_superTaunt_4) && state != confectistate.taunt && state != confectistate.appear)
    {
